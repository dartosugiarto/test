 ...
 * @version 4.2.0 (Enhanced without breaking logic)
 */
...
(function () {
  ...
  function renderPreorderCards() { 
    ...
    if (pageData.length === 0) { 
      listContainer.innerHTML = `<div class="empty"><div class="empty-content"><svg xmlns="http://www.w3.org/2000/svg" class="empty-icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" /></svg><p>Tidak Ada Hasil Ditemukan</p></div></div>`; 
    ...
    pageData.forEach(item => { 
      ...
      if (state.preorder.displayMode === 'detailed') { 
        ...
        const expandIndicatorHtml = detailsHtml ? `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="expand-indicator" aria-hidden="true"><path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd" /></svg>` : ''; 
  ...
  async function initializeLibrary() {
    ...
    try {
      ...
      renderLibraryGrid(books, container);
  ...
  function renderLibraryGrid(books, container) {
    if (!container) return;
    ...
    books.forEach(book => {
      ...
      card.setAttribute('aria-label', `Baca buku: ${book.title}`);
      card.innerHTML = `
